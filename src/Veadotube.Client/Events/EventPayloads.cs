...
public sealed record NodeListChangedEventPayload : IVeadotubeEvent<NodeListChangedEventPayload>
{
    ...
    /// <inheritdoc />
    public static JsonTypeInfo<NodeListChangedEventPayload> JsonTypeInfo =>
        VeadotubeJsonContext.Default.NodeListChangedEventPayload;

    /// <summary>The new node list.</summary>
    [JsonPropertyName("entries")]
    public IReadOnlyList<Messages.NodeListEntry> Entries { get; init; } = [];
}
...
public sealed record BooleanChangedEventPayload : IVeadotubeEvent<BooleanChangedEventPayload>
{
    ...
    /// <inheritdoc />
    public static JsonTypeInfo<BooleanChangedEventPayload> JsonTypeInfo =>
        VeadotubeJsonContext.Default.BooleanChangedEventPayload;
...
public sealed record NumberChangedEventPayload : IVeadotubeEvent<NumberChangedEventPayload>
{
    ...
    /// <inheritdoc />
    public static JsonTypeInfo<NumberChangedEventPayload> JsonTypeInfo =>
        VeadotubeJsonContext.Default.NumberChangedEventPayload;
...
public sealed record StateChangedEventPayload : IVeadotubeEvent<StateChangedEventPayload>
{
    ...
    /// <inheritdoc />
    public static JsonTypeInfo<StateChangedEventPayload> JsonTypeInfo =>
        VeadotubeJsonContext.Default.StateChangedEventPayload;
...
public sealed record InstanceInfoEventPayload : IVeadotubeEvent<InstanceInfoEventPayload>
{
    ...
    /// <inheritdoc />
    public static JsonTypeInfo<InstanceInfoEventPayload> JsonTypeInfo =>
        VeadotubeJsonContext.Default.InstanceInfoEventPayload;
