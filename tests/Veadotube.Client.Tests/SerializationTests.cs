...
public sealed class SerializationTests
{
    ...
    {
        const string json =
            """{"time":1739023315,"name":"veadotube mini","id":"mini-08dd3cd72f015bb9-000681a2","version":"2.1","language":"en","server":"127.0.0.1:2424"}""";
        VeadotubeInstanceInfo? info = JsonSerializer.Deserialize(
            json,
    ...
    {
        const string json =
            """{"event":"list","entries":[{"type":"boolean","id":"mini","name":"push-to-talk"},{"type":"stateEvents","id":"mini","name":"avatar state"}]}""";
        NodeListResponse? list = JsonSerializer.Deserialize(
            json,
            VeadotubeJsonContext.Default.NodeListResponse
        );
